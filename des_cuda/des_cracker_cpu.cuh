...
__host__ int cpu_brute_force(const char* key_alphabet, const int key_length, const char* plaintext_alphabet, const int plaintext_length, const uint64_t ciphertext,
	uint64_t* const plaintexts, uint64_t* const keys, const int output_size);

__host__ void run_cpu_version(const char* key_alphabet, const int key_length, const char* plaintext_alphabet, const int plaintext_length, const uint64_t ciphertext,
	...
	const int output_limit)
{
	...
	int count = cpu_brute_force(key_alphabet, key_length, plaintext_alphabet, plaintext_length, ciphertext, plaintexts, keys, output_limit);
